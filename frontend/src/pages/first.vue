      ...
      <div class="d-flex flex-grow-0 first-page-check" style>
        <div class="d-flex align-center">
          ...
          <v-checkbox
            ...
            label="이 페이지 다시 안 보기"
          />
          <div class="d-flex flex-grow-0" style="margin-left: 12px">
            <s-button @click="onSkipClick" size="small">메인으로 가기</s-button>
          </div>
        </div>
      </div>
    </div>
